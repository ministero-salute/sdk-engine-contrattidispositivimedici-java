...
package it.mds.sdk.flusso.ct2.controller;
...
public class FlussoCt2ControllerRest implements ValidazioneController<RecordDtoCt2> {

    private final ParserRegole parserRegole;
    private final ParserTracciato parserTracciato;
    private final FlussoCt2Service flussoCt2Service;
    private final ConfigurazioneFlussoCt2 conf;

    private final MultiValueMap<String, String> headers;

    @Autowired
    public FlussoCt2ControllerRest(@Qualifier("parserRegoleCt2") final ParserRegole parserRegole,
                                   @Qualifier("parserTracciato") final ParserTracciato parserTracciato,
                                   @Qualifier("flussoCt2Service") final FlussoCt2Service flussoCt2Service,
                                   @Qualifier("configurazioneFlussoCt2") ConfigurazioneFlussoCt2 conf) {
        this.parserRegole = parserRegole;
        this.parserTracciato = parserTracciato;
        this.flussoCt2Service = flussoCt2Service;
        this.conf = conf;
    ...
    @Override
    @PostMapping(path = "v1/flusso/contrattidispositivi")
    public ResponseEntity<RisultatoInizioValidazione> validaTracciato(@RequestBody FlussoRequest flusso, String nomeFlussoController) {
        ...
        flussoCt2Service.lanciaValidazioniPerFlusso(dimensioneBlocco,flusso,infoRun,gestoreRunLog,regoleFlusso);
    ...
    @Override
    public ResponseEntity<RisultatoValidazione> validaRecord(RecordRequest<RecordDtoCt2> recordRequest, String nomeFlusso) {
        return null;
    }
    ...
    @Override
    @GetMapping("v1/flusso/contrattidispositivi/info")
